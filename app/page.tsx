    ...
    roles: [
      {
        ...
        skills: ["React", "TypeScript", "Python", "Node.js", "PostgreSQL", "MongoDB", "Docker", "PM2", "TOTVS Protheus (ADVPL)", "REST APIs", "ETL"],
      },
      {
        title: "Aprendiz",
        type: "Meio período",
        ...
        skills: ["Python", "Node.js", "ADVPL", "Supabase", "SQL Server", "Git", "TOTVS Protheus (ADVPL)"],
      },
    ],
  },
]
...
const skills = [
  ...
  { name: "TOTVS Protheus (ADVPL)", icon: "https://www.systax.com.br/site/wp-content/uploads/2023/06/Systax-parceiros-logo-Totvs.jpg", level: 3, category: "Backend" },
...
const projects = [
  ...
  },
  {
    ...
    description: "Sistema full-stack para orquestrar movimentações internas de estoque com integração TOTVS Protheus (ADVPL). Validações em tempo real de saldos (SB2), controle de rastro/endereçamento (bins), formulários condicionais e execução de rotinas automáticas (ExecAuto) para efetivação no ERP.",
    ...
    <>
      ...
      >
        ...
        <main className="relative z-10">
            ...
            <div className="container mx-auto px-4 lg:px-12">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="order-2 lg:order-1 text-center lg:text-left">
                  ...
                  <p className="text-lg lg:text-xl text-muted-foreground/80 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
                  ...
                  <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-y-8 mb-10 p-6 sm:p-8 rounded-[2.5rem] bg-card/20 backdrop-blur-2xl border border-white/10 shadow-2xl relative overflow-hidden group">
                    ...
                    {stats.map((stat, index) => (
                      <div key={index} className="flex-1 flex items-center justify-center relative w-1/2 sm:w-auto z-10">
                        <div className="flex flex-col text-center group/stat">
                          <div className="text-4xl md:text-5xl font-black text-foreground group-hover/stat:text-primary group-hover/stat:scale-110 transition-all duration-500 leading-none tracking-tighter">
                            {stat.value}
                          </div>
                          <div className="text-[10px] text-muted-foreground/60 font-black uppercase tracking-[0.2em] mt-3 group-hover/stat:text-primary/70 transition-colors">
                            {stat.label}
                          </div>
                        </div>
                ...
                <div className="order-1 lg:order-2 flex justify-center lg:justify-end relative">
                  <div className="relative w-full max-w-[320px] sm:max-w-[400px] aspect-[4/5] animate-in fade-in zoom-in duration-1000 mt-8 lg:mt-0">
                    <div className="absolute inset-0 rounded-[3rem] overflow-hidden isolation-isolate shadow-2xl flex flex-col items-center justify-end">
                      <div className="relative w-full h-full origin-bottom rounded-[3rem] overflow-hidden">
                        <Image
                          src="/jean.png"
                          alt="Jean Correa"
                          fill
                          className="object-cover object-top rounded-[3rem]"
                          priority
                          onError={(e) => {
                  ...
                  <div className="flex overflow-x-auto pb-4 gap-2 scrollbar-hide -mx-4 px-4 md:flex-wrap md:justify-center md:mx-0 md:px-0 md:overflow-visible">
                    <button
                      ...
                      className={`whitespace-nowrap px-5 py-2 rounded-full text-xs sm:text-sm font-medium transition-all duration-300 border ${selectedFilter === null
                        ...
                        : "bg-background/20 backdrop-blur-sm hover:bg-muted text-muted-foreground border-border/50 hover:border-primary/50 hover:text-foreground"
                        }`}
                    >
                      Todos
                    </button>
          ...
          {/* Experience Section */}
          <section id="experiencia" className="py-12 md:py-24 lg:py-32 scroll-mt-20">
            <div className="container mx-auto px-4 lg:px-8">
              <AnimatedSection animation="fade-up">
      ...
      <button
        onClick={() => scrollToSection("sobre")}
        className={`fixed bottom-32 right-6 z-[70] p-4 rounded-full bg-primary text-primary-foreground shadow-2xl transition-all duration-500 group ${scrolled && !isModalOpen ? "opacity-100 translate-y-0 active:scale-95" : "opacity-0 translate-y-10 pointer-events-none"
          }`}
